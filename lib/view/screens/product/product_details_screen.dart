...
class ProductDetailsScreen extends StatelessWidget {
  ...
  _loading(BuildContext context) async {
    ...
    print(
        'review list Widget: ${Provider.of<ProductProvider>(context, listen: false).productReviewList.length}');
  }
        ...
        if (productProvider.product != null &&
                                ...
                                children: [
                                  Expanded(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                              '${productProvider.product.rating.length > 0 ? double.parse(productProvider.product.rating.first.average).toStringAsFixed(1) : 0.0}',
                                              style: TextStyle(
                                                  fontSize: 70,
                                          ...
                                          RatingBar(
                                              rating: productProvider.product
                                                          .rating.length >
                                                      0
          ...
          if (isExistInCart) {
            priceWithQuantity = priceWithDiscount *
                _cartProvider
                    .cartList[_cartProvider.getCartProductIndex(
                                            ...
                                            children: [
                                              SizedBox(
                                                ...
                                                child: FadeInImage.assetNetwork(
                                                  ...
                                                  fit: BoxFit.cover,
                                                  image:
                                                      '${Provider.of<SplashProvider>(context, listen: false).baseUrls.productImageUrl}/${productProvider.product.image[Provider.of<CartProvider>(context, listen: false).productSelect]}',
                                                  imageErrorBuilder:
                                                      (c, o, s) => Image.asset(
                                                          Images.placeholder(
                                                              context),
                                                                    ...
                                                                    decoration: BoxDecoration(
                                                                        borderRadius:
                                                                            BorderRadius.circular(Dimensions
                                                                                .RADIUS_SIZE_SMALL),
                                                                        border: Border.all(
                                                                            color: index == Provider.of<CartProvider>(context, listen: false).productSelect
                                                                    ...
                                                                    decoration:
                                                                      ...
                                                                      borderRadius:
                                                                          BorderRadius.circular(
                                                                              5),
                                                                      border: productProvider.variationIndex[index] !=
                                                                              i
                                                                          ? Border.all(
                                                              ...
                                                              return Row(
                                                                ...
                                                                children: [
                                                                  InkWell(
                                                                    onTap: () {
                                                                      if (_isLoggedIn) {
                                                                        if (wishList
                                                                            .wishIdList
                                                                            .contains(productProvider.product.id)) {
                                                                        ...
                                                                        showCustomSnackBar(
                                                                            getTranslated('not_logged_in',
                                                                                context),
                                                                            context);
                                                                    },
                                                                    child: Icon(
                                                                      wishList.wishIdList.contains(productProvider
                                                                              .product
                                                                              .id)
                                                                          ? Icons
                                                                              .favorite
                                                                          : Icons
                                                                              .favorite_border,
                                                                      size: 25,
                                                                      color: wishList.wishIdList.contains(productProvider
                                                                              .product
                                                                              .id)
                                                                          ? Theme.of(context)
                                                                              .cardColor
                                                                  ...
                                                                  SizedBox(
                                                                      width: 5),
                                                                  Text(
                                                                    wishList.localWishes.contains(productProvider
                                                                            .product
                                                                            .id)
                                                                        ? (productProvider.product.wishlistCount +
                                                                                1)
                                                                            .toString()
                                                                        : wishList.localRemovedWishes.contains(productProvider.product.id)
                                                                            ? (productProvider.product.wishlistCount - 1).toString()
                                                                            : productProvider.product.wishlistCount.toString(),
                                                                    style: rubikMedium.copyWith(
        ...
        if (isExistInCart) {
          ...
          if (!isIncrement && quantity > 1) {
            Provider.of<ProductProvider>(context, listen: false)
                .setQuantity(false, stock, context);
          } else if (isIncrement) {
            if (quantity < stock) {
              Provider.of<ProductProvider>(context, listen: false)
                  .setQuantity(true, stock, context);
            } else {
              showCustomSnackBar(
                  getTranslated('out_of_stock', context), context);
            }
